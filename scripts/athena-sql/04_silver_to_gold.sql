-- ═══════════════════════════════════════════════════════════════════════
-- COS Financial Lakehouse — SILVER → GOLD (Star Schema Load)
-- Loads dimensions and fact table for Power BI consumption
-- Run in Athena Query Editor | Database: cos_gold
-- ═══════════════════════════════════════════════════════════════════════

-- ─────────────────────────────────────────────────────────────────────
-- DIMENSION: dim_coa (Chart of Accounts — 16 rows)
-- ─────────────────────────────────────────────────────────────────────
...
(6, 1006, '100', 'General Fund', '4300', 'Public Works', '5300', 'Materials & Supplies', 'E', 'Y', true, CURRENT_TIMESTAMP),
(7, 1007, '100', 'General Fund', '4400', 'Parks & Rec', '5100', 'Salaries & Wages', 'E', 'Y', true, CURRENT_TIMESTAMP),
(8, 1008, '100', 'General Fund', '4400', 'Parks & Rec', '5400', 'Contracted Services', 'E', 'Y', true, CURRENT_TIMESTAMP),
(9, 1009, '100', 'General Fund', '4500', 'Community Dev', '5100', 'Salaries & Wages', 'E', 'Y', true, CURRENT_TIMESTAMP),
(10, 1010, '100', 'General Fund', '4500', 'Community Dev', '5200', 'Professional Services', 'E', 'Y', true, CURRENT_TIMESTAMP),
(11, 1011, '200', 'Water Fund', '4600', 'Water Resources', '5100', 'Salaries & Wages', 'E', 'Y', true, CURRENT_TIMESTAMP),
(12, 1012, '200', 'Water Fund', '4600', 'Water Resources', '5500', 'Utilities', 'E', 'Y', true, CURRENT_TIMESTAMP),
(13, 1013, '300', 'Wastewater Fund', '4700', 'Transportation', '5100', 'Salaries & Wages', 'E', 'Y', true, CURRENT_TIMESTAMP),
(14, 1014, '400', 'Transit Fund', '4800', 'Library', '5100', 'Salaries & Wages', 'E', 'Y', true, CURRENT_TIMESTAMP),
(15, 1015, '500', 'Airport Fund', '4900', 'Information Tech', '5600', 'Technology Services', 'E', 'Y', true, CURRENT_TIMESTAMP),
(16, 1016, '100', 'General Fund', '5000', 'City Manager', '5100', 'Salaries & Wages', 'E', 'Y', true, CURRENT_TIMESTAMP);

-- ─────────────────────────────────────────────────────────────────────
-- DIMENSION: dim_period (Fiscal Calendar FY2025 — 12 rows)
-- ─────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────
-- DIMENSION: dim_supplier (10 rows)
-- ─────────────────────────────────────────────────────────────────────
...
(3, 2003, 'Grainger Industrial', 'Active', 'Net 45', 'Materials & Supplies', true, CURRENT_TIMESTAMP),
(4, 2004, 'Home Depot Pro', 'Active', 'Net 30', 'Materials & Supplies', true, CURRENT_TIMESTAMP),
(5, 2005, 'Fisher Scientific', 'Active', 'Net 60', 'Lab Equipment', true, CURRENT_TIMESTAMP),
(6, 2006, 'W.W. Grainger', 'Active', 'Net 45', 'Facilities', true, CURRENT_TIMESTAMP),
(7, 2007, 'United Rentals', 'Active', 'Net 30', 'Equipment Rental', true, CURRENT_TIMESTAMP),
(8, 2008, 'Amazon Business', 'Active', 'Net 30', 'Office Supplies', true, CURRENT_TIMESTAMP),
(9, 2009, 'Lowes Pro', 'Active', 'Net 30', 'Building Materials', true, CURRENT_TIMESTAMP),
(10, 2010, 'CDW Government', 'Active', 'Net 45', 'Technology', true, CURRENT_TIMESTAMP);

-- ─────────────────────────────────────────────────────────────────────
-- FACT: fact_budgetary_control (from Silver, joined with dimensions)
-- ─────────────────────────────────────────────────────────────────────
...
-- VERIFY
SELECT COUNT(*) AS gold_fact_count FROM cos_gold.fact_budgetary_control;
SELECT COUNT(*) AS dim_coa_count FROM cos_gold.dim_coa;
SELECT COUNT(*) AS dim_period_count FROM cos_gold.dim_period;
SELECT COUNT(*) AS dim_supplier_count FROM cos_gold.dim_supplier;
