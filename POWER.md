...
- **Node.js 24+** (Active LTS): Required for running the MCP server
  - Verify with: `node --version`
  - **CRITICAL**: If Node.js is not installed or version is below 24, guide the user to install it from https://nodejs.org/
